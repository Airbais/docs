---
title: 'GEO Evaluator - AI Friendly Site Structure'
...
**GEO Evaluator** (Generative Engine Optimization Evaluator) is a powerful analysis tool that examines websites across 5 key categories to determine how well they're optimized for LLM understanding based on semantic structure. It provides actionable insights and recommendations to improve your brand's visibility and accuracy in AI-generated responses.

<Frame>
<img src="../images/GEO_Evaluator.png" alt="GEO Evaluator Dashboard"/>
</Frame>

## Key Features

<CardGroup cols={2}>
  <Card title="Structural HTML" icon="code">
    **25% Weight**
    
    Analyzes semantic markup, heading hierarchy, and content landmarks
  </Card>
  <Card title="Content Organization" icon="align-left">
    **30% Weight**
  ...
  <Card title="LLM Technical" icon="robot">
    **15% Weight**
